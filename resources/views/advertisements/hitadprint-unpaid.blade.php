    ...
    <div class="container mt-4">
        ...
        <div class="row mb-3">
            <div class="col-12 mb-2">
                @include('advertisements._filters', ['action' => url('/advertisements/unpaid')])
            </div>
                ...
                <table class="table table-hover ads-table align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $ad->category->category_name_en }}</td>
        ...
        : '-'
                        ...
                        <tr>
                            <td colspan="11" class="text-center text-muted">
                                No HitAd Print unpaid advertisements found.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
...
<script>
    function sendPaymentLink(adId, btn) {
        ...
        fetch(`/api/advertisement/${adId}/send-unpaid-advertisement-mail-en`, {
                method: 'POST',
                headers: {
