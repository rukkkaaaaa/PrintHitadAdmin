                ...
                <div class="table-responsive p-3">
                    ...
                    <table class="table table-hover ads-table align-middle mb-0">
                        ...
                        @forelse($ads as $ad)
                            ...
                            <tr class="{{ !empty($ad->print_hitad_viewed_by_admin_id) ? 'viewed-row' : '' }}">
                                ...
                                <td>
                                    ...
                                    @if(!empty($ad->print_hitad_viewed_by_admin_id))
                                        ...
                                        <span class="badge bg-success">
                                            ...
                                            {{ $ad->print_viewed_admin_name ?? 'Admin' }}

                                        </span>

                                        @if(!empty($ad->print_hitad_viewed_at))

                                            <small class="text-muted d-block mt-1">

                                                {{ \Carbon\Carbon::parse($ad->print_hitad_viewed_at)->format('Y-m-d H:i') }}
                                    ...
                                    @if(empty($ad->print_hitad_viewed_by_admin_id))
                                        ...
                                        @php
                                            ...
                                            $viewUrl = $publication === 'lahipita'
                                                ? url('/advertisements/lahipita/print-on-paper/' . $ad->id . '/view')
                                                : url('/advertisements/hitad/print-on-paper/' . $ad->id . '/view');
